...
try 101 'main() {int x; int y; x=100; y=1; return x+y;}'
try 0 'main() {int x; int y; x=y=1; return x-y;}'
try 10 'main() {int x; int y; x=100;x=200;y=0;y=y+10;return y;}'

# test control flow
## if
try 10 'main() {if(1>0) return 10; else return 20;}'
try 100 'main() {int x; if(2>1) x=100; else x=200; return x;}'
try 16 'main() {int x; x=4; if(x>0) if(x<10) return x*x;}'
try 10 'main() {int x; x=0; if(1>0) if(1<0) x = x+1; else x = x+10; else x = x+100; return x;}'
try 3 'main() {int x; x=3; if(x==1) return 1; else if(x==2) return 2; else if(x==3) return 3;}'
## while
try 10 'main() {int x; x=0; while(x<10) x=x+1; return x;}'
try 1 'main() {while(0) return 0; return 1;}'
try 100 'main() {while(1) while(1) return 100;}'
## for
try 5 'main() {for(;;) return 5; return 2;}'
try 123 'main() {int x; for(x=123;;) return x;}'
try 11 'main() {int x; x=0; for(;;x=x+1) if(x>10) return x;}'
try 10 'main() {int x; int y; y=0; for(x=0; x<10; x=x+1) y=y+1; return y;}'

# test block
try 10 'main() {int x; x=0; x=x+10; return x;}'
try 2 'main() {int x; x=10; if(x==10) {x=x*2; return x/10;}}'
try 123 'main() {int x; if(0==0) {} return 123;}'
...
try 10 'main() {int x; x=0; if(x>1) return x; return x+10; }'

# test pointer
try 10 'main() {int x; int y; x = 10; y = &x; return *y;}'
